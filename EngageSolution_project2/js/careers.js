...
acc[0].addEventListener("click", function(){
        ...
        acc[1].nextElementSibling.classList.remove("show2");
        acc[1].classList.toggle("active2",false);
        acc[2].nextElementSibling.classList.remove("show2");
        acc[2].classList.toggle("active2",false);
        acc[3].nextElementSibling.classList.remove("show2");
        acc[3].classList.toggle("active2",false);
 	 });
acc[1].addEventListener("click", function(){
        this.classList.toggle("active2");
        this.nextElementSibling.classList.toggle("show2");
        acc[0].nextElementSibling.classList.remove("show2");
        acc[0].classList.toggle("active2",false);
        acc[2].nextElementSibling.classList.remove("show2");
        acc[2].classList.toggle("active2",false);
        acc[3].nextElementSibling.classList.remove("show2");
        acc[3].classList.toggle("active2",false);
